...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionECDHE_WITH_AES_128 = QtGui.QAction(MainWindow)
        self.actionECDHE_WITH_AES_128.setCheckable(True)
        self.actionECDHE_WITH_AES_128.setChecked(True)
        self.actionECDHE_WITH_AES_128.setObjectName(_fromUtf8("actionECDHE_WITH_AES_128"))
        self.actionRSA_WITH_AES_128 = QtGui.QAction(MainWindow)
        self.actionRSA_WITH_AES_128.setCheckable(True)
        self.actionRSA_WITH_AES_128.setObjectName(_fromUtf8("actionRSA_WITH_AES_128"))
        self.menuSettings.addSeparator()
        self.menuSettings.addAction(self.actionECDHE_WITH_AES_128)
        self.menuSettings.addAction(self.actionRSA_WITH_AES_128)
        self.menuSettings.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionECDHE_WITH_AES_128.setText(_translate("MainWindow", "ECDHE_WITH_AES_128", None))
        self.actionRSA_WITH_AES_128.setText(_translate("MainWindow", "RSA_WITH_AES_128", None))
